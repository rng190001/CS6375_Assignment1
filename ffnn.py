...
def load_data(train_data, val_data, test_data):
    ...
    #     "Number of Examples": [len(training), len(validation), len(testing)],
    #     "Average Length of Reviews": [compute_avg_length(training), compute_avg_length(validation), compute_avg_length(testing)],
    # }
